...
export const adminAPI = {
  ...
  getDiscordBotSettings: () => api.get('/admin/settings/discord-bot'),
  updateDiscordBotSettings: (data: Record<string, unknown>) => api.put('/admin/settings/discord-bot', data),
  getDiscordBotRuntimeStatus: () => api.get('/admin/settings/discord-bot/runtime-status'),
  getDiscordBroadcasts: (params?: Record<string, unknown>) =>
    api.get('/admin/discord-bot/broadcasts', { params }),
  getDiscordBroadcast: (id: number) =>
    api.get(`/admin/discord-bot/broadcasts/${id}`),
  createDiscordBroadcast: (data: {
    title: string
    recipient_type: string
    user_ids?: number[]
    filters?: Record<string, unknown>
    ...
    attachment_name?: string
    message_html: string
  }) => api.post('/admin/discord-bot/broadcasts', data),
  getDiscordBroadcastUsers: (params?: Record<string, unknown>) =>
    api.get('/admin/discord-bot/users', { params }),

  getDiscordManagedUsers: (params?: Record<string, unknown>) =>
    api.get('/admin/discord-bot/users/manage', { params }),
  updateDiscordManagedUser: (id: number, data: Record<string, unknown>) =>
    api.put(`/admin/discord-bot/users/${id}`, data),
  getDiscordOrders: (params?: Record<string, unknown>) =>
    api.get('/admin/discord-bot/orders', { params }),
  getDiscordPaymentIssues: (params?: Record<string, unknown>) =>
    api.get('/admin/discord-bot/payment-issues', { params }),
  syncDiscordPaymentIssue: (paymentId: number) =>
    api.post(`/admin/discord-bot/payment-issues/${paymentId}/sync`),
