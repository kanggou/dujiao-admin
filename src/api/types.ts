...
export type AdminDiscordBotRuntimeStatus = AdminTelegramBotRuntimeStatus
export type AdminDiscordBroadcast = AdminTelegramBroadcast

export interface AdminDiscordBroadcastUser {
  user_id: number
  display_name: string
  user_email: string
