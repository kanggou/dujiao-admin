...
const navGroups = computed<NavGroup[]>(() => {
  const groups: NavGroup[] = [
    ...
    {
      id: 'discordBot',
      label: t('admin.navGroups.discordBot'),
      icon: Bot,
      items: [
        { label: '概览', to: '/discord-bot', icon: Bot, permission: 'GET:/admin/settings/discord-bot' },
        { label: '基础设置', to: '/discord-bot/settings', icon: SlidersHorizontal, permission: 'GET:/admin/settings/discord-bot' },
        { label: '交互配置', to: '/discord-bot/interaction', icon: ImageIcon, permission: 'GET:/admin/settings/discord-bot' },
        { label: '连接状态', to: '/discord-bot/status', icon: Wifi, permission: 'GET:/admin/settings/discord-bot' },
        { label: 'Bot 客户端', to: '/discord-bot/channel-clients', icon: KeyRound, permission: 'GET:/admin/channel-clients' },
        { label: 'Discord 用户', to: '/discord-bot/users', icon: Users, permission: 'GET:/admin/discord-bot/users/manage' },
        { label: '订单中心', to: '/discord-bot/orders', icon: ListOrdered, permission: 'GET:/admin/discord-bot/orders' },
        { label: '支付异常', to: '/discord-bot/payment-issues', icon: AlertCircle, permission: 'GET:/admin/discord-bot/payment-issues' },
        { label: '消息模板', to: '/discord-bot/message-templates', icon: FileText, permission: 'GET:/admin/settings/discord-bot' },
        { label: '风控设置', to: '/discord-bot/risk-control', icon: ShieldCheck, permission: 'GET:/admin/settings/discord-bot' },
        { label: '消息群发', to: '/discord-bot/broadcasts', icon: Send, permission: 'GET:/admin/discord-bot/broadcasts' },
      ],
    },
    {
      id: 'system',
