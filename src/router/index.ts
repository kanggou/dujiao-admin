  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { permission: 'GET:/admin/settings/discord-bot' },
      },
      {
        path: 'discord-bot/settings',
        name: 'discord-bot-settings',
        component: () => import('@/views/admin/DiscordBotSettings.vue'),
        meta: { permission: 'GET:/admin/settings/discord-bot' },
      },
      {
        path: 'discord-bot/interaction',
        name: 'discord-bot-interaction',
        component: () => import('@/views/admin/DiscordBotInteractionHub.vue'),
        meta: { permission: 'GET:/admin/settings/discord-bot' },
      },
      // 旧路径重定向到合并后的交互配置页
      { path: 'discord-bot/panel-template', redirect: { name: 'discord-bot-interaction' } },
      { path: 'discord-bot/help-center', redirect: { name: 'discord-bot-interaction' } },
      { path: 'discord-bot/menu', redirect: { name: 'discord-bot-interaction' } },
      {
        path: 'discord-bot/status',
        name: 'discord-bot-status',
        component: () => import('@/views/admin/DiscordBotStatus.vue'),
        meta: { permission: 'GET:/admin/settings/discord-bot' },
      },
      {
        path: 'discord-bot/channel-clients',
        name: 'discord-bot-channel-clients',
        component: () => import('@/views/admin/DiscordBotChannelClients.vue'),
        meta: { permission: 'GET:/admin/channel-clients' },
      },
      {
        path: 'discord-bot/users',
        name: 'discord-bot-users',
        component: () => import('@/views/admin/DiscordBotUsers.vue'),
        meta: { permission: 'GET:/admin/discord-bot/users/manage' },
      },
      {
        path: 'discord-bot/orders',
        name: 'discord-bot-orders',
        component: () => import('@/views/admin/DiscordBotOrders.vue'),
        meta: { permission: 'GET:/admin/discord-bot/orders' },
      },
      {
        path: 'discord-bot/payment-issues',
        name: 'discord-bot-payment-issues',
        component: () => import('@/views/admin/DiscordBotPaymentIssues.vue'),
        meta: { permission: 'GET:/admin/discord-bot/payment-issues' },
      },
      {
        path: 'discord-bot/message-templates',
        name: 'discord-bot-message-templates',
        component: () => import('@/views/admin/DiscordBotMessageTemplates.vue'),
        meta: { permission: 'GET:/admin/settings/discord-bot' },
      },
      {
        path: 'discord-bot/risk-control',
        name: 'discord-bot-risk-control',
        component: () => import('@/views/admin/DiscordBotRiskControl.vue'),
        meta: { permission: 'GET:/admin/settings/discord-bot' },
      },
      {
        path: 'discord-bot/broadcasts',
        name: 'discord-bot-broadcasts',
        component: () => import('@/views/admin/DiscordBotBroadcasts.vue'),
        meta: { permission: 'GET:/admin/discord-bot/broadcasts' },
      },
      {
        path: 'discord-bot/broadcasts/create',
        name: 'discord-bot-broadcast-create',
        component: () => import('@/views/admin/DiscordBotBroadcastCreate.vue'),
        meta: { permission: 'GET:/admin/discord-bot/broadcasts' },
      },
      {
        path: 'discord-bot/broadcasts/:id',
        name: 'discord-bot-broadcast-detail',
        component: () => import('@/views/admin/DiscordBotBroadcastDetail.vue'),
        meta: { permission: 'GET:/admin/discord-bot/broadcasts' },
      },
    ],
  },
